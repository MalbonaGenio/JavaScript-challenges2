...
const bar = 'Moon'
const cafe = 'Blue Bottle'
const restaurant = 'Pancho'

favouritePlaces = {bar, cafe, restaurant, 
    greetings(place) {console.log(`Favourite place is: ${place}`)},
}

favouritePlaces.greetings(bar)